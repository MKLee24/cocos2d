...
void ChooseMan::CreateItem() {
	...
	man1->setPosition(Vec2(poin.x / 2 - 3 * man1->getContentSize().width / 2 - 30, Director::getInstance()->getVisibleSize().height / 2));
	...
	man3->setPosition(Vec2(poin.x / 2 + man1->getContentSize().width / 2 + 30, Director::getInstance()->getVisibleSize().height / 2));
